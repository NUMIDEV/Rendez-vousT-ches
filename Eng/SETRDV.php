...
<center><br><br><div class="hide2"  style="border: solid 1px grey ; border-radius: 20px;padding:5px;background: white"><table>
	<h1 style="color:grey;">Schedule an appointments</h1>

	<tr><td><input type="text" name="Nom"  placeholder="Name"></td></tr>

	<tr><td><input type="text" name="Ntel"  placeholder="Phone number"></td></tr>
	<tr><td><input type="text" name="Endroit" placeholder="Place"></td></tr>
	<tr><td><input type="text" name="Objet" placeholder="Object"></td></tr>
	...
	<tr><td><input type="submit" name="ok" value="Schedule" style="background: red;padding: 10px;color: white;border-radius:  10px;border: none;" ></td></tr>
</table></div></center>
</form>
