...
if($j==0){
  ...
  <h1 id='get2' style='color:grey;'>List of appointments for the day $Date2</h1><br>
...
if ($i==0) {
	...
	echo "<center> <h1 id='get2' style='color:grey;'>List of appointments for the day $Date2</h1><br>
  <h3><span class='zoomer' style='color: red' >No appointment for the ".$Date2."</span></h3></center>";	
}
