...
if($j==0){
  ...
  <h1 id='get2' style='color:grey;'>Les rendez-vous du $Date2</h1><br>
...
if ($i==0) {
	...
	echo "<center><h1 id='get2' style='color:grey;'>Les rendez-vous du $Date2</h1><h3><span class='zoomer' style='color: red'>Pas de rendez-vous pour le ".$Date2."</span></h3></center>";	
}
