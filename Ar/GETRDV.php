...
<center>
	...
	<h1 style="color:grey;">البحث عن المواعيد   </h1>

	<tr><td><input type="date" name="Date1" ></td></tr>
	<tr><td> 
		<input type="submit" name="ok1" value="بحث" style="background: red;padding: 10px;color: white;border-radius:  10px;border: none;" >
	</td></tr>
</table></div></center>
</form>
